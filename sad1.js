var rid='1915d6bc364x80c4c785-xdjnj56';
...
$(`<style>
.nosel.d-flex.room.r1915d6bc364x80c4c785-xdjnj56 .fitimg.u-pic.borderg {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel.d-flex.room.r1915d6bc364x80c4c785-xdjnj56 .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
  letter-spacing: 1px;
...
.nosel.d-flex.room.r1915d6bc364x80c4c785-xdjnj56.bord {border-inline: 0px solid #4c121e !important;}
.nosel.d-flex.room.r1915d6bc364x80c4c785-xdjnj56 .dots.mini.u-msg {
    text-align: center;
...
.nosel.d-flex.room.r1915d6bc364x80c4c785-xdjnj56 {
    background-image: url(https://up6.cc/2024/08/172435719830181.gif);
...
.nosel.d-flex.room.r1915d6bc364x80c4c785-xdjnj56 .u-topic.dots {
...
#upro.l7dah1 .modal-header.label-primary {
  ...
  background-image: url(https://up6.cc/2024/08/172435523430141.png);
  background-size: cover;
}
...
#d2.l7dah1 .label-primary{background-color:#8b7cb7!important}#d2.l7dah1 .bg{background-color:#8b7cb7!important}#d2.l7dah1 .uzr.d-flex.mm.hmsg{border-radius: 10px 0 10px;background-color: #807f7f!important;}#dpnl.l7dah1{background-size: 100%;background-image: url(https://up6.cc/2024/08/172435523430141.png);background-color: #727272;  }#dpnl.l7dah1 .light{background-color:#878686!important;background-image:linear-gradient(ffdf49,#ffffff 0%,#ebeaea 29%,#fff7f7 67%,#f7f7f7 100%);}#d0b500.l7dah1 .nosel.fl.bg.{background-color:#b77c9a!important;  }#users.l7dah1 span.uhash{text-transform:uppercase;background-image:linear-gradient(-225deg,#565555 0,#737373 29%,#ebebeb 67%,#0096ff 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}
...
#d0.l7dah1 .label-primary {
    ...
    border-radius: 10px 0 10px!important;
    background-image: url(https://up6.cc/2024/08/172435745277531.png);
    color: #ffffff;
    background-size: 100%;
}
...
#upro.l7dah1 .light.fl.pro.break {
    ...
    background-image: url(https://up6.cc/2024/08/17243577175581.png);
    background-size: 100%;
}
#mic.l7dah1 #muteall {
    border-radius: 10px 0 10px;
...
setInterval(function () {
    if (myroom == '1915d6bc364x80c4c785-xdjnj56') {
        if (l7dah == false) {
            l7dah = true;
